...
describe("pricing (R6-H, R6-9)", () => {
  ...
  test("the cohort is priced, and every price is `official-doc` with a page URL and an instant", () => {
    expect(priced.map((m) => m.key).sort()).toEqual([
      // 2026-09-25 refresh: regenerated from the shipped catalog after the first-party provider refresh (Codex-mapped,
      // Claude-reviewed evidence; every price is an `official-doc` page with its URL and instant, CNY rows converted with the rate stated in sourceRef).
      "alibaba-anthropic/qwen3-coder-next",
      "alibaba-anthropic/qwen3-coder-plus",
      "alibaba-anthropic/qwen3.5-122b-a10b",
      "alibaba-anthropic/qwen3.5-397b-a17b",
      "alibaba-anthropic/qwen3.5-plus",
      "alibaba-anthropic/qwen3.6-27b",
      "alibaba-anthropic/qwen3.6-flash",
      "alibaba-anthropic/qwen3.6-plus",
      "alibaba-anthropic/qwen3.7-max",
      "alibaba-anthropic/qwen3.7-plus",
      "alibaba-anthropic/qwen3.8-flash",
      "alibaba-anthropic/qwen3.8-max",
      "alibaba-cn-anthropic/qwen3-coder-next",
      "alibaba-cn-anthropic/qwen3-coder-plus",
      "alibaba-cn-anthropic/qwen3.5-122b-a10b",
      "alibaba-cn-anthropic/qwen3.5-397b-a17b",
      "alibaba-cn-anthropic/qwen3.5-plus",
      "alibaba-cn-anthropic/qwen3.6-27b",
      "alibaba-cn-anthropic/qwen3.6-flash",
      "alibaba-cn-anthropic/qwen3.6-plus",
      "alibaba-cn-anthropic/qwen3.7-max",
      "alibaba-cn-anthropic/qwen3.7-plus",
      "alibaba-cn-anthropic/qwen3.8-flash",
      "alibaba-cn-anthropic/qwen3.8-max",
      "alibaba-cn/qwen3-coder-next",
      ...
      "google-openai/gemini-2.5-flash",
      "google-openai/gemini-2.5-flash-lite",
      "google-openai/gemini-2.5-pro",
      "google-openai/gemini-3-flash-preview",
      "google-openai/gemini-3.1-flash-lite",
      "google-openai/gemini-3.1-pro-preview",
      "google-openai/gemini-3.5-flash",
      "google-openai/gemini-3.5-flash-lite",
      "google-openai/gemini-3.6-flash",
      "google-openai/gemini-3.7-flash",
      ...
      "meta-anthropic/muse-spark-1.1",
      "meta-anthropic/muse-spark-1.2",
      "meta-anthropic/muse-spark-1.3",
      "meta/muse-spark-1.1",
      "meta/muse-spark-1.2",
      "meta/muse-spark-1.2-contributor",
      "meta/muse-spark-1.3",
      "meta/muse-spark-1.3-contributor",
      "minimax-anthropic/MiniMax-M2",
      "minimax-anthropic/MiniMax-M2.1",
      "minimax-anthropic/MiniMax-M2.1-highspeed",
      "minimax-anthropic/MiniMax-M2.5",
      "minimax-anthropic/MiniMax-M2.5-highspeed",
      "minimax-anthropic/MiniMax-M2.7",
      "minimax-anthropic/MiniMax-M2.7-highspeed",
      "minimax-anthropic/MiniMax-M3",
      "minimax-cn-anthropic/MiniMax-M2",
      "minimax-cn-anthropic/MiniMax-M2.1",
      "minimax-cn-anthropic/MiniMax-M2.1-highspeed",
      "minimax-cn-anthropic/MiniMax-M2.5",
      "minimax-cn-anthropic/MiniMax-M2.5-highspeed",
      "minimax-cn-anthropic/MiniMax-M2.7",
      "minimax-cn-anthropic/MiniMax-M2.7-highspeed",
      "minimax-cn-anthropic/MiniMax-M3",
      ...
      "qianfan-anthropic/ernie-4.5-turbo-128k",
      "qianfan-anthropic/ernie-4.5-turbo-20260402",
      "qianfan-anthropic/ernie-4.5-turbo-32k",
      "qianfan-anthropic/ernie-4.5-turbo-vl",
      "qianfan-anthropic/ernie-4.5-turbo-vl-32k",
      "qianfan-anthropic/ernie-5.0",
      "qianfan-anthropic/ernie-5.0-thinking-exp",
      "qianfan-anthropic/ernie-5.0-thinking-latest",
      "qianfan-anthropic/ernie-5.0-thinking-preview",
      "qianfan-anthropic/ernie-5.1",
      "qianfan/ernie-4.5-turbo-128k",
      "qianfan/ernie-4.5-turbo-20260402",
      "qianfan/ernie-4.5-turbo-32k",
      "qianfan/ernie-4.5-turbo-vl",
      "qianfan/ernie-4.5-turbo-vl-32k",
      "qianfan/ernie-5.0",
      "qianfan/ernie-5.0-thinking-exp",
      ...
      "tencent-tokenhub-anthropic/hy4-preview",
      "tencent-tokenhub-intl-anthropic/hy3",
      "tencent-tokenhub-intl-anthropic/hy4-preview",
      "tencent-tokenhub-intl/hy3",
      "tencent-tokenhub-intl/hy4-preview",
      "tencent-tokenhub/hunyuan-role-latest",
      ...
      "xai/grok-4.7",
      "xai/grok-build-0.1",
      "xiaomi-anthropic/mimo-v2.5",
      "xiaomi-anthropic/mimo-v2.5-pro",
      "xiaomi-anthropic/mimo-v2.6-flash",
      "xiaomi-anthropic/mimo-v2.6-pro",
      "xiaomi-anthropic/mimo-v2.6-pro-ultraspeed",
      "xiaomi/mimo-v2.5",
      ...
      "zai/glm-5.3-flash",
      "zai/glm-5.3-flashx",
      "zhipu-anthropic/glm-5.3",
      "zhipu-anthropic/glm-5.3-flash",
      "zhipu/glm-4.5-air",
      "zhipu/glm-4.7",
      "zhipu/glm-4.7-flash",
...
describe("standing floors", () => {
  ...
  test("no row is `supported` — upstream presence promotes nothing (WS-13 §13)", () => {
    // `deprecated` (2026-09-25 refresh) is a vendor-retired row kept so its key stays known (listings and slots drop it);
...
describe("WS-13b §2: the widened catalog", () => {
  ...
  test("every dialect sibling states its dialect in its display name, and never shares an endpoint with its twin", () => {
    ...
    // 2026-09-25 refresh: every first-party OpenAI/Anthropic dialect pair added in the refresh joins the original four.
    for (const [primary, sibling] of [
      ["deepseek", "deepseek-anthropic"], ["zai", "zai-anthropic"], ["moonshot", "kimi-coding"], ["minimax", "minimax-anthropic"],
      ["moonshot", "moonshot-anthropic"], ["moonshot-cn", "moonshot-cn-anthropic"], ["zhipu", "zhipu-anthropic"],
      ["zhipu-coding", "zhipu-coding-anthropic"], ["minimax-cn", "minimax-cn-anthropic"], ["minimax-token-plan", "minimax-token-plan-anthropic"],
      ["minimax-cn-token-plan", "minimax-cn-token-plan-anthropic"], ["alibaba", "alibaba-anthropic"], ["alibaba-cn", "alibaba-cn-anthropic"],
      ["qwen-cloud-token-plan", "qwen-token-plan-anthropic"], ["qwen-coding", "qwen-coding-anthropic"], ["qwen-coding-cn", "qwen-coding-cn-anthropic"],
      ["kimi-coding-intl-openai", "kimi-coding-intl"], ["xiaomi", "xiaomi-anthropic"], ["xiaomi-token-plan", "xiaomi-token-plan-anthropic"],
      ["xiaomi-token-plan-cn", "xiaomi-token-plan-cn-anthropic"], ["xiaomi-token-plan-eu", "xiaomi-token-plan-eu-anthropic"],
      ["qianfan", "qianfan-anthropic"], ["qianfan-coding", "qianfan-coding-anthropic"], ["tencent-tokenhub", "tencent-tokenhub-anthropic"],
      ["tencent-tokenhub-intl", "tencent-tokenhub-intl-anthropic"], ["tencent-coding", "tencent-coding-anthropic"],
      ["tencent-token-plan", "tencent-token-plan-anthropic"], ["meta", "meta-anthropic"],
    ] as const) {
