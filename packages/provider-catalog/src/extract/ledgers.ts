...
export const FIELD_PROVENANCE: readonly FieldProvenance[] = [
  ...
  { field: "reasoning.continuationDomain / summaryRequest / readableState / completionEvent / toolLoopRequirement / effortRequest", provenance: "official-doc-derived", note: "OVERLAY ONLY. Continuation domain is a first-class documented fact, never inferred from a shared HTTP shape (WS-13 §8.2)" },
];
