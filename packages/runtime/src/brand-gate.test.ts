...
const BRANDLESS_CALL_SITE_ALLOWLIST: Readonly<Record<string, string>> = {
  ...
  "packages/runtime/src/tools/registry.ts:805": "RESERVED_MCP_SERVER_NAMES' module-load SEED -- the `from` side; `rebrandStandingServerTools` adds the session's own name (line shifted again by WS-21 §6.3 item 1's pluginWorkflows field, fix round 2)",
