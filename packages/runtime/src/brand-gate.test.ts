...
const BRANDLESS_CALL_SITE_ALLOWLIST: Readonly<Record<string, string>> = {
  ...
  "packages/sdk/src/query.ts:571": "the FALLBACK side of `options.brand?.envPrefix ?? WINTER_BRAND.envPrefix` (M-1's fix)",
  "packages/sdk/src/query.ts:734": "a COMPARISON against the default, deciding whether to emit the deprecated top-level key",
