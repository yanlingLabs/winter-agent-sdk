...
const BRANDLESS_CALL_SITE_ALLOWLIST: Readonly<Record<string, string>> = {
  ...
  "packages/sdk/src/query.ts:579": "the FALLBACK side of `options.brand?.envPrefix ?? WINTER_BRAND.envPrefix` (M-1's fix)",
  "packages/sdk/src/query.ts:742": "a COMPARISON against the default, deciding whether to emit the deprecated top-level key",
