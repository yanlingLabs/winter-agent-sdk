...
// extractPaths seam -- see read.ts's own comment on the (input)->{reads,writes} signature's lack of
// a cwd parameter; `path`-or-process.cwd() is the same documented best-effort placeholder.
